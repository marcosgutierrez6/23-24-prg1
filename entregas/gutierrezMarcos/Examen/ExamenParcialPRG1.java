...
public class ExamenParcialPRG1 {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 1; i < 8; i++) {
            ...
            for (int k = 7; k >= 1; k--) {
                ...
                if (i == 1) {
                    ...
                    System.out.println("D1: " + consumoDia1 + "| D2: " + consumoDia2 + "| D" + i + ":" + " " + consumoDia3);
                    acumulacionConsumo = 0;
                } else if (i == 4) {
                    consumoDia4 = consumoDia4 + obtenerAcumulacionConsumo();
                    System.out.println("D1: " + consumoDia1 + "| D2: " + consumoDia2 + "| D3: " + consumoDia3 + "| D" + i + ":" + " " + consumoDia4);
                    acumulacionConsumo = 0;
                } else if (i == 5) {
                    consumoDia5 = consumoDia5 + obtenerAcumulacionConsumo();
                    System.out.println("D1: " + consumoDia1 + "| D2: " + consumoDia2 + "| D3: " + consumoDia3 + "| D4:" + consumoDia4 + " | D" + i + ":" + " " + consumoDia5);
                    acumulacionConsumo = 0;
                } else if (i == 6) {
                    consumoDia6 = consumoDia6 + obtenerAcumulacionConsumo();
                    System.out.println("D1: " + consumoDia1 + "| D2: " + consumoDia2 + "| D3: " + consumoDia3 + "| D4:" + consumoDia4 + "| D5:" + consumoDia5 + " | D" + i + ":" + " " + consumoDia6);
                    acumulacionConsumo = 0;
                } else if (i == 7) {
                    consumoDia7 = consumoDia7 + obtenerAcumulacionConsumo();
                    System.out.println("D1: " + consumoDia1 + "| D2: " + consumoDia2 + "| D3: " + consumoDia3 + "| D4:" + consumoDia4 + "| D5:" + consumoDia5 + "| D6: " + consumoDia6 + " | D" + i + ":" + " " + consumoDia7);
                    acumulacionConsumo = 0;
                }
        ...
        int mediaConsumoSemanal = (consumoDia1 + consumoDia2 + consumoDia3 + consumoDia4 + consumoDia5 + consumoDia6 + consumoDia7) / 7;
    ...
    static int obtenerAcumulacionConsumo() { return acumulacionConsumo; }
